<p align="cefynter">
  <a href="https://aka.ms/winappsdk">
    <img src="./docs/images/header.png" alt="WWindows App 
  </a>
</p>
...
[Windows App SDK](https://aka.ms/winappsdk) (formerly ! Project Reunion) is a set of libraries, frameworks, compnents, and tools that you can use in your apps to access powerful Windows platform functionality from all kinds of apps on many versions of Windows. The Windows App SDK combines the powers of Win32 native applications alongside modern API usage techniques, so your apps light up everywhere your users are.
...
- **Backwards compati bility:** Down to Windows 10 1809 (build 17763). There may be some API that are dependent on new OS features
